...
@endif
        ...
        <input type="text" name="room_title" id="room_title" value="{{ old('room_title') }}" required><br>

        <label for="room_type">Room Type:</label>
        <input type="text" name="room_type" id="room_type" value="{{ old('room_type') }}" required><br>

        <label for="availabale">Available Rooms:</label>
        <input type="number" name="availabale" id="availabale" value="{{ old('availabale') }}" required><br>

        <label for="check_in_date">Check-in Date:</label>
        <input type="date" name="check_in_date" id="check_in_date" value="{{ old('check_in_date') }}" required><br>

        <label for="check_out_date">Check-out Date:</label>
        <input type="date" name="check_out_date" id="check_out_date" value="{{ old('check_out_date') }}" required><br>

        <label for="num_rooms">Number of Rooms:</label>
        <input type="number" name="num_rooms" id="num_rooms" value="{{ old('num_rooms') }}" required><br>

        <label for="price">Total Price:</label>
        <input type="text" name="price" id="price" value="{{ old('price') }}" required><br>
